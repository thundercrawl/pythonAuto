...
baseURI = "https://rtpmsa.raleigh.ibm.com/msa/projects/b/build.topsail/builds/TSA/"

#labelURI can be current build or other bvtpassed txt
labelURI = baseURI+"currentBuildLabel.txt"
localLabelFile="currentBuildLabel.txt"
logMode="debug";
debugLevel=2
...
baseSource="/projects/b/build.topsail/builds/TSA/"
source=baseSource+labelName[labelName.__len__()-1].strip()+"/"
dest="D:/build/traveler/driverbuilds"
...
ftp.cwd("/Projects/Traveler/driverbuilds")
rt=[]
